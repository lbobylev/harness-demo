...
@Component
public class Lg4jAgentExecutor {
    ...
    protected Lg4jAgentExecutor() {
        this(new MetricsAgent(), new LogsAgent(), new TracesAgent(), new DeploymentsAgent(),
                new ConfigChangesAgent(), new MetricComparisonAgent(), new LogSignatureAgent());
    }

    public Lg4jAgentExecutor(
    ...
    public static Lg4jAgentExecutor defaults() {
        return new Lg4jAgentExecutor();
    }
